    ...
    body: [
      h('div', { class: 'col' },
        h('div', { class: 'row wrap', style: { gap: '6px' } },
          ...
          (() => { const st = NPC.statusOf(state, id); return st.label === '在岗' ? null : tag(st.label, st.kind); })(),
          r.role ? tag(r.role, 'mind') : null,
        ...
        return h('div', { class: 'item', role: 'button', tabindex: '0', onClick: () => openNpc(ctx, c.id) },
          ...
          h('div', { class: 'grow' },
            ...
            h('div', { class: 'row wrap', style: { gap: '4px', marginTop: '2px' } },
              ...
              r.role ? tag(r.role, 'mind') : null,
              (() => { const st = NPC.statusOf(state, c.id); return st.label === '在岗' ? null : tag(st.label, st.kind); })(),
